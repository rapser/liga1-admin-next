              ...
              <div className="w-full max-w-md">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-sm text-[#67748e]">
                    Inicia sesión para acceder al panel de administración de la Liga 1
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <Button
                    ...
                    className="w-full h-12 text-base font-semibold bg-gradient-info hover:opacity-90 transition-opacity shadow-soft-lg border-0"
                    size="lg"
                  >
                    {isSigningIn ? (
                      <>
